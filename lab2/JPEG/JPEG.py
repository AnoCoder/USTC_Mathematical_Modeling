...
class KJPEG:
    ...
    def Compress(self, filename, result_name):
        ...
        buff = 0
        tfile = os.path.splitext(result_name)[0] + ".gpj"
    ...
    def Decompress(self, filename, result_name):
...
if __name__ == '__main__':
    kjpeg = KJPEG()
    kjpeg.Compress("../assets/image/image_bmp/lena.bmp", './lena.gpj')
    kjpeg.Decompress("./lena.gpj", "lena_JPEG.bmp")  # 将得到的.gpj文件解编码以可视化
    kjpeg.Compress("../assets/image/image_bmp/sunrise.bmp", './sunrise.gpj')
    kjpeg.Decompress("./sunrise.gpj", "sunrise_JPEG.bmp")  # 将得到的.gpj文件解编码以可视化
